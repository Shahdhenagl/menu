...
export default function CustomerMenu({
  ...
  const t = {
    ar: {
      ...
      subtitle: "استمتع بتجربة طعام فريدة وقائمة طعام تفاعلية فاخرة",
    ...
    en: {
      ...
      subtitle: "Enjoy a unique dining experience with a premium interactive menu",
        ...
        <div style={{ maxWidth: '600px', margin: '0 auto' }}>
          ...
          <div className="footer-social-links">
            {settings.facebook_url && (
              <a href={settings.facebook_url} target="_blank" rel="noreferrer" className="social-icon-btn" title="Facebook">
            ...
            {settings.instagram_url && (
              <a href={settings.instagram_url} target="_blank" rel="noreferrer" className="social-icon-btn" title="Instagram">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ display: 'block' }}>
            ...
            {settings.tiktok_url && (
              <a href={settings.tiktok_url} target="_blank" rel="noreferrer" className="social-icon-btn" title="TikTok">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ display: 'block' }}>
            ...
            {settings.snapchat_url && (
              <a href={settings.snapchat_url} target="_blank" rel="noreferrer" className="social-icon-btn" title="Snapchat">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ display: 'block' }}>
            ...
            {settings.whatsapp_number && (
              <a href={`https://wa.me/${settings.whatsapp_number}`} target="_blank" rel="noreferrer" className="social-icon-btn" title="WhatsApp">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ display: 'block' }}>
